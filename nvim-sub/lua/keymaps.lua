...
local maps, nmaps, omaps, imaps = require('wagomu-box.utils').maps , require('wagomu-box.utils').nmaps , require('wagomu-box.utils').omaps, require('wagomu-box.utils').imaps
